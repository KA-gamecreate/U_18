...
public class Skill3 : MonoBehaviour
{
    ...
    {
        audioSource = GetComponent<AudioSource>();
        stagemaker.GetComponent<kyukyo2>().playerTurn = false;
        stagemaker.GetComponent<kyukyo2>().yourturn.SetActive(false);
        stagemaker.GetComponent<kyukyo2>().enemyturn.SetActive(true);
